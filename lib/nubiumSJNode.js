var WebSocket = require('ws'),
    ...
    NubiumRestServices = require('./nubiumRestServices'),
    NubiumWebSocket = require('./nubiumWebSocket');

exports = module.exports = NubiumSJNode;

/*
* Initializes a new instance of the NubiumSJNode class.
*/
function NubiumSJNode() {
    ...
    *   ortcClient.saveAuthentication('http://ortc-developers.nubium.io/server/2.1/', true, 'myAuthenticationToken', 0, 'myApplicationKey', 1400, 'myPrivateKey', { "channel1": "wrp", "channel2": "w" }, function (error, success) {
    *       if (error) {
    ...
    */
        ...
        if (isCluster) {
            ...
            function (error, body) {
                if (error != null) {
                    ...
                    NubiumRestServices.saveAuthentication(connectionUrl, authenticationToken, authenticationTokenIsPrivate, applicationKey, timeToLive, privateKey, permissions, callback);
                }
            });
        } else {
            NubiumRestServices.saveAuthentication(connectionUrl, authenticationToken, authenticationTokenIsPrivate, applicationKey, timeToLive, privateKey, permissions, callback);
     ...
     *          isCluster : true,
     *          url : 'http://ortc-developers.nubium.io/server/2.1/',
        ...
        try{
            ...
            function(error,serverUrl){
                if(error){
                    ...
                    NubiumRestServices.getPresence({
                        url : serverUrl,
                        appKey : appKey,
                        authToken : authToken,
        ...
        try{
            ...
            function(error,serverUrl){
                if(error){
                    ...
                    NubiumRestServices.enablePresence({
                        url : serverUrl,
                        appKey : appKey,
        ...
        try{
            ...
            function(error,serverUrl){
                if(error){
                    ...
                    NubiumRestServices.disablePresence({
                        url : serverUrl,
                        appKey : appKey,
                        privateKey : parameters.privateKey,
                        channel : parameters.channel
    ...
    */
    var createSocketConnection = function (connectionUrl) {
        if (ortc.sockjs == null) {
            ...
            var socket = new NubiumWebSocket(wsScheme + '://' + wsUrl + '/broadcast/' + serverId + '/' + connid + '/websocket');
